...
Architecture Role creates the initial product plan, architecture, documentation, and AI operating rules, then hands routine development to Implementation Role. Design Role owns design. Implementation Role owns implementation and documentation synchronization. QA Role performs verification independently from implementation.
